...
//			url: baseUrl + 'user/emailCheck.do',
			url: 'http://localhost:9999/waku/user/chkByUser.do',
			type: 'post',
			data: {
				uEmail: $('#email').val()
			},
...
//				url: baseUrl + 'user/add.do',
				url: 'http://localhost:9999/waku/user/signUp.do',
				type: 'post',
				data: {
					uEmail: $('#email').val(),
...
//						url: baseUrl + 'user/selectNo.do',
						url: 'http://localhost:9999/waku/user/selectuNo.do',
						type: 'post',
						data: {
							uEmail: $('#email').val()
						},
						success: function(no){
							...
							localStorage.setItem('uNo', parseInt(no.jsonResult.data));
