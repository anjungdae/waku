...
$(document).ready(function () {
  var nbP = $('.container nav').length;
  var w = parseInt($('.container nav').css("width"));
  var max = (nbP - 1) * w;
  ...
  $('body').on('click','.use', function(){
    ...
    if (-margL < max && modulo == 0) {
      ...
      $('.container').animate({backgroundColor:'#5E5E5E'},200);
      $('#cancel').animate({opacity:1.0},200);
  ...
  // cancel 버튼 사용시.
       ...
       $('#cancel').animate({opacity:0.0},200);
       });
     }
    else  {}
  });
